...
'            <button id="addLookupBtn" class="good">Add Lookup Result as Pending Stream</button>',
...
'        <div class="notice">Admin login: <b>admin</b></div>',
...
'  return fetch(path, options).then(async function(r){',
...
'}',
'function renderStream(s, admin) {',
'  const status = s.computed_status || s.status;',
'  const link = s.youtube_video_url || s.channel_url;',
'  let adminButtons = "";',
'  if (admin) {',
'    adminButtons =',
'      "<button class=\"good\" onclick=\"approve(" + s.id + ")\">Approve</button>" +',
'      "<button class=\"warn\" onclick=\"rejectStream(" + s.id + ")\">Reject</button>" +',
'      "<button class=\"blue\" onclick=\"editStream(" + s.id + ")\">Edit</button>" +',
'      "<button class=\"secondary\" onclick=\"deleteStream(" + s.id + ")\">Delete</button>";',
'  }',
'  return "" +',
'    "<div class=\"stream\">" +',
